...
set -A complete_ad_1 -- init update run clean push-roles show-roles show-hosts show-groups show-groupvars
# second level completion: options and groups
set -A complete_ad_2 -- -m -l -t -h -v -n -j $(adq show-groups)
